...
def read_every_single_file_to_dictionary(feedbackpath_f2, feedback_list_names_f2):
...

    {
        ...
        feedback:   [comentario1,   comentario2,    comentario3...]
    }
    ...
    for element in feedback_list_names_f2:
        with open(os.path.join(feedbackpath_f2, element), 'r') as file:
            ...
            #print(text_lines_list) #BORRAR CUANDO TERMINE
            ...
            for index in range(0, len(text_lines_list)):
                if index == 0:                    
                    dictionary["title"].append(text_lines_list[index])
                elif index == 1:
                    dictionary["name"].append(text_lines_list[index])
                elif index == 2:
                    dictionary["date"].append(text_lines_list[index])
                elif index == 3:
                    dictionary["feedback"].append(text_lines_list[index])    
